...
class FundamentalistApiResponse(BaseModel):
    meta: FundamentalistMetadata
    tables: TableData
...
if __name__ == '__main__':
    # Example of usage
    market_response = {'meta': {'date_time': '2024-10-07 19:40:11', 'user': 'username', 'server': 'minerva.comdinheiro.com.br', 'feature': 'HistoricoCotacaoAcao001', 'execution_time': '0.139', 'encode': 'utf8', 'JSON_UNESCAPED_UNICODE': True, 'JSON_PRETTY_PRINT': True, 'JSON_UNESCAPED_SLASHES': True, 'variables': {'get': {'x': 'C2PT34', 'data_ini': '01092024', 'data_fim': '01102024', 'flag_ajusta': '1', 'pagina': '1', 'flag_export': 'json3', 'ep': '1', 'ip_cliente': '000.000.000.00'}}}, 'tables': {'tab0': {'lin0': {'col0': 'Data', 'col1': 'Fech Ajustado', 'col2': 'Variação(%)', 'col3': 'Fech Histórico', 'col4': 'Abertura Ajustado', 'col5': 'Mín Ajustado', 'col6': 'Médio Ajustado', 'col7': 'Máx Ajustado', 'col8': 'Vol (MM R$)', 'col9': 'Negócios', 'col10': 'Fator', 'col11': 'Tipo', 'col12': 'Quant em Aluguel', 'col13': 'Vol em Aluguel(MM R$)'}, 'lin1': {
        'col0': '02/09/2024', 'col1': 'nd', 'col2': 'nd', 'col3': 'nd', 'col4': 'nd', 'col5': 'nd', 'col6': 'nd', 'col7': 'nd', 'col8': 'nd', 'col9': 'nd', 'col10': 'nd', 'col11': 'nd', 'col12': 'nd', 'col13': 'nd'}, 'lin2': {'col0': '03/09/2024', 'col1': 'nd', 'col2': 'nd', 'col3': 'nd', 'col4': 'nd', 'col5': 'nd', 'col6': 'nd', 'col7': 'nd', 'col8': 'nd', 'col9': 'nd', 'col10': 'nd', 'col11': 'nd', 'col12': 'nd', 'col13': 'nd'}, 'lin3': {'col0': '04/09/2024', 'col1': '46,5376660921', 'col2': 'nd', 'col3': '46,8', 'col4': '46,5376660912', 'col5': '46,5376660912', 'col6': '46,5376660912', 'col7': '46,5376660912', 'col8': '0,000234', 'col9': '1,00', 'col10': '1', 'col11': 'DRN', 'col12': 'nd', 'col13': 'nd'}}}}
    market_response_obj = MarketApiResponse(**market_response)
    print(market_response_obj)

    fund_response = {'meta': {'date_time': '2024-10-07 19:33:41', 'user': 'username', 'server': 'minerva.comdinheiro.com.br', 'feature': 'HistoricoIndicadoresFundamentalistas001', 'execution_time': '0.140', 'encode': 'utf8', 'JSON_UNESCAPED_UNICODE': True, 'JSON_PRETTY_PRINT': True, 'JSON_UNESCAPED_SLASHES': True, 'variables': {'get': {'ep': '1', 'data_ini': '01/09/2024', 'data_fim': '01/10/2024', 'trailing': '3', 'conv': 'MIXED', 'moeda': 'MOEDA_ORIGINAL', 'c_c': 'consolidado', 'm_m': '1000000', 'n_c': '2', 'f_v': '1', 'papel': 'C2PT34', 'indic': 'NOME_EMPRESA LL RL IPL ROE AT PL VPA QUANT_ON QUANT_PN QUANT_ON_PN CCL LG DESPESA_FINANCEIRA DIVIDA_BRUTA FCO EBITDA DEPRE_AMOR', 'periodicidade': 'tri', 'graf_tab': 'tabela', 'desloc_data_analise': '1', 'flag_transpor': '0', 'c_d': 'd', 'enviar_email': '0', 'enviar_email_log': '0', 'cabecalho_excel': 'modo1', 'relat_alias_automatico': 'cmd_alias_01', 'flag_export': 'json3', 'ip_cliente': '000.000.000.00'}}}, 'tables': {'tab0': {'lin0': {'col0': 'Data', 'col1': 'C2PT34\nNome da Empresa', 'col2': 'C2PT34\nLucro Líquido\n3 meses\nConsolidado\n Milhões\n', 'col3': 'C2PT34\nReceita Líquida\n3 meses\nConsolidado\n Milhões\n', 'col4': 'C2PT34\nP/L', 'col5': 'C2PT34\nROE', 'col6': 'C2PT34\nAtivo Total\nConsolidado\n Milhões\n',
    ...
    fund_response_obj = FundamentalistApiResponse(**fund_response)
    print(fund_response_obj)
