...
if __name__ == '__main__':
    ...
    # market_data_obj = TableData(**market_data)
    ...
    # fundamentalist_data_obj = TableData(**fundamentalist_data)
    # print(fundamentalist_data_obj)
    

    fund_response = {'meta': {'date_time': '2024-10-07 19:33:41', 'user': 'luiza.santos.101767', 'server': 'minerva.comdinheiro.com.br', 'feature': 'HistoricoIndicadoresFundamentalistas001', 'execution_time': '0.140', 'encode': 'utf8', 'JSON_UNESCAPED_UNICODE': True, 'JSON_PRETTY_PRINT': True, 'JSON_UNESCAPED_SLASHES': True, 'variables': {'get': {'ep': '1', 'data_ini': '01/09/2024', 'data_fim': '01/10/2024', 'trailing': '3', 'conv': 'MIXED', 'moeda': 'MOEDA_ORIGINAL', 'c_c': 'consolidado', 'm_m': '1000000', 'n_c': '2', 'f_v': '1', 'papel': 'C2PT34', 'indic': 'NOME_EMPRESA LL RL IPL ROE AT PL VPA QUANT_ON QUANT_PN QUANT_ON_PN CCL LG DESPESA_FINANCEIRA DIVIDA_BRUTA FCO EBITDA DEPRE_AMOR', 'periodicidade': 'tri', 'graf_tab': 'tabela', 'desloc_data_analise': '1', 'flag_transpor': '0', 'c_d': 'd', 'enviar_email': '0', 'enviar_email_log': '0', 'cabecalho_excel': 'modo1', 'relat_alias_automatico': 'cmd_alias_01', 'flag_export': 'json3', 'ip_cliente': '134.238.230.80'}}}, 'tables': {'tab0': {'lin0': {'col0': 'Data', 'col1': 'C2PT34\nNome da Empresa', 'col2': 'C2PT34\nLucro Líquido\n3 meses\nConsolidado\n Milhões\n', 'col3': 'C2PT34\nReceita Líquida\n3 meses\nConsolidado\n Milhões\n', 'col4': 'C2PT34\nP/L', 'col5': 'C2PT34\nROE', 'col6': 'C2PT34\nAtivo Total\nConsolidado\n Milhões\n', 'col7': 'C2PT34\nPatrimônio Líquido\nConsolidado\n Milhões\n', 'col8': 'C2PT34\nVPA', 'col9': 'C2PT34\nQUANT_ON', 'col10': 'C2PT34\nQUANT_PN', 'col11': 'C2PT34\nQUANT_ON_PN', 'col12': 'C2PT34\nCCL', 'col13': 'C2PT34\nLG', 'col14': 'C2PT34\nDespesa Financeira\n3 meses\nConsolidado\n Milhões\n', 'col15': 'C2PT34\nDívida Bruta\n Milhões', 'col16': 'C2PT34\nFluxo de Caixa das Operações\n3 meses\nConsolidado\n Milhões\n', 'col17': 'C2PT34\nEBITDA\n3 meses\nConsolidado\n Milhões\n', 'col18': 'C2PT34\nDespesa de Depreciação, Amortização e Exaustão\n3 meses\nConsolidado\n Milhões\n', 'col19': 'C2PT34\nConsolidado\nou\nControlador', 'col20': 'C2PT34\nConvenção', 'col21': 'C2PT34\nMoeda', 'col22': 'C2PT34\nData da Demonstração', 'col23': 'meses', 'col24': 'Data da Análise'}, 'lin1': {'col0': '30/06/2024', 'col1': 'CAMDEN PROPERTY TRUST', 'col2': '42,917', 'col3': '387,15', 'col4': '275,807981453', 'col5': '0,883895177368', 'col6': '9079,574', 'col7': '4855,44', 'col8': '44,7894028006', 'col9': '108,640497', 'col10': '0', 'col11': '108,640497', 'col12': '-304,651', 'col13': '0,0281674315018', 'col14': '32,227', 'col15': '3552,81', 'col16': '225,069', 'col17': '222,392', 'col18': '145,894', 'col19': 'consolidado', 'col20': 'US GAAP', 'col21': 'USD', 'col22': '30/06/2024', 'col23': '3', 'col24': '01/07/2024'}}}}
